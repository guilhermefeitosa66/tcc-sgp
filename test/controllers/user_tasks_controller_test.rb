...
class UserTasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_task" do
    assert_difference('UserTask.count') do
      post user_tasks_url, params: { user_task: { task_id: @user_task.task_id, user_id: @user_task.user_id } }
    end
  ...
  test "should update user_task" do
    patch user_task_url(@user_task), params: { user_task: { task_id: @user_task.task_id, user_id: @user_task.user_id } }
