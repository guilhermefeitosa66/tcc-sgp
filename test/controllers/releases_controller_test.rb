...
class ReleasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post releases_url, params: { release: { deliver_date: @release.deliver_date, project_id: @release.project_id, version: @release.version } }
    end
  ...
  test "should update release" do
    patch release_url(@release), params: { release: { deliver_date: @release.deliver_date, project_id: @release.project_id, version: @release.version } }
