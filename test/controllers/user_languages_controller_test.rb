...
class UserLanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_language" do
    assert_difference('UserLanguage.count') do
      post user_languages_url, params: { user_language: { language_id: @user_language.language_id, user_id: @user_language.user_id } }
    end
  ...
  test "should update user_language" do
    patch user_language_url(@user_language), params: { user_language: { language_id: @user_language.language_id, user_id: @user_language.user_id } }
