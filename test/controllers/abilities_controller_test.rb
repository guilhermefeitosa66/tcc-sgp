...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { description: @ability.description, name: @ability.name, scope: @ability.scope } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { description: @ability.description, name: @ability.name, scope: @ability.scope } }
