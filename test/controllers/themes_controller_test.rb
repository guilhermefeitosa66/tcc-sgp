...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post themes_url, params: { theme: { name: @theme.name, project_id: @theme.project_id } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { name: @theme.name, project_id: @theme.project_id } }
